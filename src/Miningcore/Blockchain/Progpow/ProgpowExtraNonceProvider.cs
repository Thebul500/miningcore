...
public class PhicoinExtraNonceProvider : ExtraNonceProviderBase
{
    public PhicoinExtraNonceProvider(string poolId, byte? clusterInstanceId) : base(poolId, PhicoinConstants.ExtranoncePlaceHolderLength, clusterInstanceId)
    {
    }
}
